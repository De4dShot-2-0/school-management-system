          ...
          <div class="col-12">
            ...
            <div class="box box-widget widget-user">
                ...
                <div class="widget-user-header bg-black">
                    ...
                    <h6 class="mt-10 widget-user-desc">User Email: {{ $user->email }}</h6>
                    <h6 class="mt-15 widget-user-desc">Role: {{ $user->usertype }}</h6>
                  
                </div>
                <div class="text-center">
                  <img style="border: 1px solid #ffffff;" class="rounded-circle w-350 mb-30"
